...
data_strings["ocean_c_1"] = fuck_up_text(
    "Here~ are~ the 7~~~~ P~~~~M~~~~ ob~ser~va~tions for~~ the\n"
    "~~~Bos~ton~~ metro~po~li~tan~~~ ar~ea.\n\n"
    "~~~~~~~~~~~~~~~At Logan~~~~ Airport,~~~~~~ it was clou~~~~dy.\n"
    "~~~~~~~~~~~~~~~The tem~per~a~ture was 6~~~~8~~~~ de~grees,\n"
    ...
    "~~~~~~~~Elsewher",
    100,
) + fuck_up_text("rrrrrrrrr\n", 900)

data_strings["ocean_c_2"] = fuck_up_text(
    "Here~ are~ the 7~~~~ P~~~~M~~~~ ob~ser~va~tions for~~ the\n"
    "~~~Bos~ton~~ metro~po~li~tan~~~ ar~ea.\n\n"
    "~~~~~~~~~~~~~~~At Logan~~~~ Airport,~~~~~~ it was clou~~~~dy.\n"
    "~~~~~~~~~~~~~~~The tem~per~a~ture was 6~~~~8~~~~ de~grees,\n"
...
data_strings["ocean_c_3"] = fuck_up_text(
    "Here~ are~ the 7~~~~ P~~~~M~~~~ ob~ser~va~tions for~~ the\n"
    "~~~Bos~ton~~ metro~po~li~tan~~~ ar~ea.\n\n"
    "~~~~~~~~~~~~~~~At Logan~~~~ Airport,~~~~~~ it was clou~~~~dy.\n"
    "~~~~~~~~~~~~~~~The tem~per~a~ture was 6~~~~8~~~~ de~grees,\n"
...
data_strings["funding_1"] = split_word_template(
    "Broad####cast####\n"
...
data_strings["funding_2"] = split_word_template(
    "--####--####-- ####-i####-a-####---- ####-up####-o-#\n"
...
data_strings["fundingx2_0"] = split_word_template(
    " By\n"
    "  ci\n"
    "    po\n"
    "      po\n"
...
data_strings["fundingx2_1"] = split_word_template(
    "\n".join(
        "{}#### Unknown###".format(work_out_date((64 * 3390) + i * 64)).replace(
            ".", ".####"
        )
        for i in range(26)
    )
...
data_strings["fundingx2_2"] = split_word_template(
...
data_strings["fdg_single_0"] = split_word_template(
    "########.########.########.########.########.########.########.#######\n"
    "########.########.########.########.########.########.########.#######\n"
    "########.########.########.########.########.########.########.#######\n"
    "########.########.########.########.########.########.########.#######\n"
...
data_strings["fdg_down_0"] = split_word_template(
    "Fun####ding#### for#### this#### pro####gram#### was#\n"
    "made#### made#### made#### made#### made#### made#### made#### made#### made###\n"
    "pos####sible#### by#### view####ers#### like#### you.#######"
)

data_strings["fdg_down_1"] = split_word_template(
    "---####----#### ---#### ----#### ---####----#### ---#\n"
    "----#### ----#### ----#### ----#### ----#### ----#### ----#### ----#### ----###\n"
    "---####-----#### --#### ----####---###### ----######## -##-##-##.#######"
)

data_strings["fdg_down_2"] = split_word_template(
    "Fun####ding#### for#### this#### pro####gram#### was#\n"
    "made#### made#### made#### made#### made#### made#### made#### made#### made###\n"
