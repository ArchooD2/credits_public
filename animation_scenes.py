...
clear_scene = am.Scene(
    ...
    (
        am.Generator(
            0,
            am.Generator.at_beat(0),
            lambda g: noise(canvas, 0, 40 * 24, ("##",), (Style.BRIGHT + Fore.WHITE,)),
            am.Generator.no_request(),
            am.Generator.no_request(),
        ),
        am.Generator(
    ...
    (
        am.Generator(
            ...
            lambda g, b: canvas.set_string(
                0,
                Vector2(0, 14),
                update_ocean_slices(g.get_data("ocean"), g.get_data("ocean_glitch")),
                g.get_data("ocean_col"),
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
    ...
    (
        ...
        am.Generator(
            ...
            lambda g, b: type_text(
                ...
                int(b**1.143) % 20 not in (0, 8, 17, 15),
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g: g.set_data("text", "", "offset", 0),
            lambda g, b: type_text(
                canvas, g, 0, 1, 1, Style.BRIGHT + Fore.RED, int(b**1.2) % 20 in (0, 15)
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g: g.set_data("text", "", "offset", 0),
            lambda g, b: type_text(
                canvas, g, 0, 1, 1, Style.BRIGHT + Fore.RED, int(b**1.2) % 20 == 8
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g: g.set_data("text", "", "offset", 0),
            lambda g, b: type_text(
                canvas, g, 0, 1, 1, Style.BRIGHT + Fore.RED, int(b**1.2) % 20 == 17
            ),
            am.Generator.no_request(),
        ),
    ),
...
beats = am.Scene(
    ...
    (
        ...
        am.Generator(
            0,
            am.Generator.combine_conditions(
                am.Generator.every_on_off(48, 16), am.Generator.every_n_beats(4)
            ),
            lambda g: g.set_data("beat_toggle", True),
            lambda g, b: beat_toggle(
                canvas, g, 0, 18, 22, 11, 15, "@@", Style.BRIGHT + Fore.YELLOW
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            0,
            am.Generator.combine_conditions(
                am.Generator.every_off_on(48, 16), am.Generator.every_n_beats(2)
            ),
            lambda g: g.set_data("beat_toggle", True),
            lambda g, b: beat_toggle(
                canvas, g, 0, 18, 22, 11, 15, "##", Style.BRIGHT + Fore.GREEN
            ),
            am.Generator.no_request(),
        ),
    ),
...
beats_lr = am.Scene(
    ...
    (
        ...
        am.Generator(
            ...
            lambda g: g.set_data("beat_toggle", True),
            lambda g, b: beat_toggle(
                canvas, g, 0, 18, 20, 11, 15, "@@", Style.BRIGHT + Fore.YELLOW
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g: g.set_data("beat_toggle", True),
            lambda g, b: beat_toggle(
                canvas, g, 0, 20, 22, 11, 15, "##", Style.BRIGHT + Fore.GREEN
            ),
            am.Generator.no_request(),
        ),
    ),
...
date_ticker = am.Scene(
    ...
    (
        ...
        am.Generator(
            64 * 8,
            am.Generator.before_n(64 * 12 - 4),
            am.Generator.no_create(),
            lambda g, b: canvas.set_string(
                0,
                Vector2(27, 15),
                work_out_date((64 * 8) + (b - (64 * 8)) * 2),
        ...
        am.Generator(
            64 * 12 + 4,
            am.Generator.combine_conditions(
                am.Generator.every_n_beats(4), am.Generator.before_n(64 * 16)
            ),
            am.Generator.no_create(),
            lambda g, b: canvas.set_string(
                0,
                Vector2(27, 15),
                work_out_date(random.randint(64 * 12 + b * 8, 64 * 12 + b * 24)),
                Fore.YELLOW + Style.BRIGHT,
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g, b: canvas.set_string(
                0,
                Vector2(27, 15),
                work_out_date(64 * 16 + b * 64 - 64 * 16 * 32),
                Fore.YELLOW + Style.BRIGHT,
            ),
            am.Generator.no_request(),
        ),
...
weather = am.Scene(
    ...
    (
        am.Generator(
            0,
            am.Generator.combine_conditions(
                am.Generator.every_n_beats(64), am.Generator.before_n(64 * 8)
            ),
            am.Generator.no_create(),
            lambda g, b: render_weather(
                canvas, 0, 27, 17, known_weathers[min(2, b // 64)], 0 if b < 128 else 1
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            64 * 8,
            am.Generator.combine_conditions(
                am.Generator.every_n_beats(32), am.Generator.before_n(64 * 12)
            ),
            am.Generator.no_create(),
        ...
        am.Generator(
            ...
            am.Generator.no_create(),
            lambda g, b: render_weather(
                canvas, 0, 27, 17, known_weathers[3], 1, max(0, (b - 1080) * 2.2)
            ),
            am.Generator.no_request(),
        ),
    ),
    ...
    (
        ...
        am.Generator(
            ...
            lambda g, b: write_history(
                canvas, g, 0, 1, 19, Fore.BLACK + Style.BRIGHT, 1
            ),
            am.Generator.no_request(),
        ),
    ),
...
loading = am.Scene(
    ...
    (
        ...
        am.Generator(
            0,
            am.Generator.combine_conditions(
                am.Generator.before_n(240), am.Generator.every_n_beats(8)
            ),
            am.Generator.no_create(),
        ...
        am.Generator(
            ...
            am.Generator.always(),
            am.Generator.no_create(),
            lambda g, b: g.scene.oper_data(
                "progress", lambda t: t + random.randint(40, 70)
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            0,
            am.Generator.before_n(240),
            am.Generator.no_create(),
            lambda g, b: canvas.set_string(
                0,
                Vector2(3, 10),
                "#" * g.scene.get_data("progress"),
                Fore.YELLOW + Style.BRIGHT,
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g, b: canvas.set_string(
                0,
                Vector2(3, 10),
                fuck_up_text("#" * g.scene.get_data("progress"), 400),
...
quick_loading = am.Scene(
    ...
    (
        ...
        am.Generator(
            ...
            am.Generator.no_create(),
            lambda g, b: g.scene.oper_data(
                "progress", lambda t: t + random.randint(4, 6)
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
    ...
    (
        ...
        am.Generator(
            ...
            lambda g, b: typewrite_by_word(
                canvas, g, 0, 2, 22, g.get_data("type_col"), history_var="history2"
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            am.Generator.no_create(),
            lambda g, b: write_history(
                canvas, g, 0, 1, 21, Fore.BLACK + Style.BRIGHT, 15, var="history2"
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g, b: typewrite_by_word(
                canvas, g, 0, 4, 5, g.get_data("type_col"), history_var="history3"
            ),
            am.Generator.no_request(),
        ),
    ),
...
access_points = am.Scene(
    ...
    (
        am.Generator(
            0,
            am.Generator.combine_conditions(
                am.Generator.before_n(20), am.Generator.every_n_beats(2)
            ),
            am.Generator.no_create(),
            lambda g, b: set_multiline_string(
                canvas,
                ...
                "\n\n".join(
                    "\n".join(
                        "   ".join(
                            (
                                (
                                    "PBS #{:02}".format((yblock * 6) + x + 1)
                                    if yline == 1
                                    else ("  ###  ", "", "Unknown")[yline]
                                )
                                if random.randint(0, max(1, 32 - int(b**1.2))) < 4
                                else "       "
                            )
                            for x in range(6)
                        )
        ...
        am.Generator(
            80,
            am.Generator.combine_conditions(
                am.Generator.every_n_beats(8), am.Generator.before_n(976)
            ),
...
funding_down = am.Scene(
    ...
    (
        am.Generator(
            ...
            lambda g, b: typewrite_by_word(
                canvas, g, 0, 1, 1 + g.get_data("lineno"), g.get_data("type_col")
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            lambda g, b: typewrite_by_word(
                canvas, g, 0, 1, 20 + g.get_data("lineno"), g.get_data("type_col")
            ),
            am.Generator.no_request(),
        ),
    ),
...
poweroff = am.Scene(
    ...
    (
        am.Generator(
            ...
            am.Generator.always(),
            am.Generator.no_create(),
            lambda g, b: make_poweroff_bars(
                canvas, b - 2, 0, Fore.BLACK + Style.NORMAL
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
            ...
            am.Generator.no_create(),
            lambda g, b: make_poweroff_bars(
                canvas, b - 1, 0, Fore.BLACK + Style.BRIGHT
            ),
            am.Generator.no_request(),
        ),
        am.Generator(
        ...
        am.Generator(
            ...
            am.Generator.no_create(),
            lambda g, b: make_poweroff_bars(
                canvas, b + 1, 0, Fore.WHITE + Style.BRIGHT
            ),
            am.Generator.no_request(),
        ),
    ),
